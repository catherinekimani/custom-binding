...
export class CoursesComponent implements OnInit {
  ...
  // this property will keep track of which radio button has been selected in the webpage
  courseCountRadioButton: string = 'All';
  // method to be called when the custom event of our child component will be raised
  ...
  // method which wil be called when our custom event from our child component will be raised
